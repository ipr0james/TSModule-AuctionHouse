 ...
 */
public class SubCommandAHConfiscated extends SpigotCommand<User> implements CommandPermission<User> {

    public SubCommandAHConfiscated(String name, String... aliases) {
        super(name, aliases);
    }
    ...
    public final boolean hasPermission(final User user) {
        return user.hasPermission("titan.command.auctionhouse.admin");
    }
}
